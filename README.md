...
| Open Enrollment Planner | Planned | Compare employer health options, per-person medical/prescription costs, annual net cost and bill-payment timing; see the scoped backlog below |
| Portable term-life comparison | Planned | Employer versus individual 10/15/30-year coverage, quarterly reviewed public rate references and employment-change continuity; see the scoped backlog below |
...
### Open Enrollment Planner — Planned

Build a compact comparison within Health that lets a household add an HSA-eligible health plan, PPO Option 1, PPO Option 2 and other alternatives. HSA eligibility is a separate plan attribute, not a substitute for network type. Reuse household, payroll, HSA and budget facts; applying a selected option must be explicit and update linked costs once. Keep inputs blank until entered or a dated reference is explicitly applied.

- **Plan terms:** employee premium per pay period and annual total, coverage tier, employer HSA contribution and deposit timing, individual/family deductibles, embedded versus aggregate family rules, copays, coinsurance, in/out-of-network limits and covered preventive services. Keep plan-year dates and source/version visible.
- **Per-person utilization:** optional anonymous household-member labels, average annual medical expenses with the basis identified (prior out-of-pocket versus insurer-allowed charges), expected visits/procedures and high-cost recurring prescriptions. Do not run deductible math against last year's out-of-pocket total as if it were allowed charges. Offer a simple annual estimate first, with category detail only when needed.
- **Prescription comparison:** per-plan formulary/tier, copay or coinsurance, specialty-drug rules, fill frequency, quantity and pharmacy restrictions, deductible exemptions or a separate drug deductible. Explicitly capture whether eligible prescription spending counts toward the medical deductible and whether medical/Rx share an out-of-pocket maximum or have separate limits. Flag unknown/noncovered drugs, out-of-network costs and manufacturer-assistance accumulator/maximizer treatment; never assume all prescription payments count toward the limit. Any drug lookup must preserve local-only privacy; do not send entered drug names or household data to third parties.
- **True annual cost:** compare premiums plus modeled member medical/Rx spending, less employer funding and supported tax savings. Show HSA contributions as transfers into an owned asset, with retained HSA balance separately, rather than treating contributions as medical spending or free savings. Separate pre-tax/payroll treatment from direct contributions and verify eligibility, limits and state treatment before calculating tax benefits. Compare low, expected and high utilization using the same household care assumptions and show where each option becomes cheaper. Do not presume the HSA option wins.
- **Charts:** stacked annual cost components, total cost versus utilization with crossover points, per-person medical/Rx breakdown, and a monthly cash-needed timeline. Distinguish covered in-network maximum exposure from premiums, noncovered care and other spending outside the cap.
- **Bill timing and liquidity:** distinguish service date, claim adjudication/EOB, actual provider bill/due date, member payment and optional HSA reimbursement. Explain that an EOB is not itself a bill. Let users model variable billing delays and compare early-year expensive care against payroll deductions and employer/employee HSA deposits. Show cash required before HSA funds accumulate and the effect of paying now versus reimbursing later. Avoid promising a standard delay or recommending delayed payment; actual provider terms and due dates govern.
- **Acceptance:** individual and family coverage; one high-cost member versus distributed claims; embedded/aggregate deductibles; preventive care; copay versus coinsurance; prescriptions with shared/separate/excluded accumulators; missing formulary data; early-year claims; delayed bills across plan years; and employer HSA funds deposited upfront versus periodically. Benefit accumulators follow the applicable plan/service rules, while cash follows payment timing. Include import/export, mobile graphs, PDF comparison and no double counting in current/retirement budgets.

Before implementation, verify applicable IRS/HSA rules and effective-dated plan benefit documents, including Summary of Benefits and Coverage, formulary and accumulator definitions. This extends the existing HSA and Batch 4 health backlog; it does not replace ACA/Medicare or imply those engines are complete.

### Portable Term-Life Comparison — Planned

Add a neutral employer-versus-individual coverage comparison alongside benefit selection. Highlight when individually owned level-term coverage offers a larger death benefit or lower comparable cost and how employment changes affect each option. Model 10-, 15- and 30-year terms explicitly; neither cheaper premiums nor underwriting acceptance are guaranteed.

- Compare like-for-like death benefit, guaranteed level-premium period, annual/monthly premium, coverage end age, employer subsidy, age-banded employer increases, portability/conversion provisions and post-employment cost. Show coverage and cumulative premiums over the same horizon; distinguish a term ending from a lapse and explain that individual coverage still depends on premiums and contract terms.
- Plan a **quarterly reviewed public reference dataset** by age bracket and insurer-used male/female rating category, term and coverage amount, with only source-supported discriminators such as tobacco use, underwriting class, jurisdiction and material eligibility restrictions. Exact birthdays, identities and medical histories are unnecessary. Keep all user inputs local.
- Establish a licensed/reusable, credible public source before implementing reference pricing. Record observation date, effective period, rating assumptions and refresh history; use reviewed snapshot updates and suppress stale price claims. No lead-generation service, quote request or third-party transmission of user details. If a suitable dataset is unavailable, retain manual quote entry instead of inventing averages or risk-class adjustments.
- Graph equal-coverage cost and equal-premium coverage where source data supports both, plus policy duration and employment-change scenarios. Surface gaps after a term expires and any need for later underwriting. Verify policy-specific continuation terms before describing coverage as portable.
- Acceptance includes employer-paid basic coverage, optional group life, age-band premium changes, job departure, portable/convertible group options, missing underwriting class, stale references and unequal coverage/term comparisons. Reuse premiums in budgets only after explicit selection. Coordinate specialized FEGLI work with Batch 3 rather than assuming ordinary group-policy rules apply.

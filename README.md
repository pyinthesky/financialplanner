...
Verified monthly/mortgage release: [`3a5f79e`](https://github.com/pyinthesky/financialplanner/commit/3a5f79e245af63b35e91b461ce84ae4a0025d18d), [successful Pages run](https://github.com/pyinthesky/financialplanner/actions/runs/34159881481). That release passed 122 tests, TypeScript/build and Chromium/WebKit at six widths. The follow-up reference/home-move/funding-visual release passes 135 local calculation/regression tests and type/build checks; its expanded browser/PDF gate must pass before deployment. See [development state](docs/development-state.md) for the exact evidence and remaining limits.

...
| Follow-up release in this commit | Home move, public spending references, lookahead reserve, envelope allocations, care events, benefit withholding and funding visuals | 133 tests/type/build pass locally; expanded browser/PDF release gate pending |
...
2. Historical replay and stochastic probability ranges need a versioned licensed dataset, asset correlations and calibration. Current stresses are user-entered deterministic paths; fees/volatility distributions are not inferred.

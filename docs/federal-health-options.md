...
- Compact directory, geography filters, 12 separate federal review slots, scalar service-price suggestions, source text and links, explicit family/formulary review, top-three full-household shortlist, pin/show-all controls and reference-version validation and automatic care recalculation. Only January 2026 comparisons use this catalog. Government contributions are not counted as employee cash benefits.
